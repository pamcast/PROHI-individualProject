...
if page == "Home":
    ...
    col1.metric("Patients with Heart Disease (%)", f"{patient_coronary:.2f}", delta="0", delta_color="inverse", border=True)
    ...
    st.bar_chart(df, x="HeartDisease", y="Sex", color="#00ccff", horizontal=True)
